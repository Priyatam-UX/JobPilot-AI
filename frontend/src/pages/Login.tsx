      ...
      <div className="w-full max-w-md relative z-10 pointer-events-none">
        ...
        <TiltCard className="bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/5 rounded-3xl p-8 shadow-2xl relative overflow-visible pointer-events-auto">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-slate-400 mt-1">Welcome back to your personal AI career copilot</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-11 py-3 bg-[#0a0a0a] border border-white/5 rounded-xl focus:border-white/20 focus:ring-1 focus:ring-white/10 outline-none text-slate-100 text-sm transition-all duration-300"
                />
                <button
                  type="button"
          ...
          <div className="grid grid-cols-2 gap-3 mb-6">
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-2.5 py-2.5 bg-[#0a0a0a] border border-white/5 hover:bg-white/5 hover:border-white/10 rounded-xl text-slate-300 text-sm transition-all duration-300"
            >
          ...
          <p className="text-center text-xs text-slate-500">
            ...
            <Link to="/register" className="text-white hover:text-slate-300 font-medium">
              Create an account
            </Link>
          </p>
        </TiltCard>
